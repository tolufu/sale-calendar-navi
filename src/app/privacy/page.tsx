  ...
  return (
    <LegalPage
      ...
      sections={[
        ...
        { heading: "Cookie・広告識別子", body: "広告配信やアクセス解析を導入する場合、Cookie、広告識別子、端末情報、閲覧ページなどが広告配信事業者により利用されることがあります。本サービスは商品価格・在庫・レビューを外部ECからスクレイピングで取得しません。v2以降の商品画像は、各ECの公式APIが返したURLに限り出典を明記して表示する場合があります。" },
