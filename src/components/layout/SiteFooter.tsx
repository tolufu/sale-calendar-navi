  ...
  return (
    <footer className="mt-12 border-t border-line bg-white">
      <div className="mx-auto max-w-6xl px-4 py-6 text-sm leading-6 text-muted">
        <p>価格やポイント条件はユーザー入力メモ、または各EC公式APIの取得時点の参考値として扱います。外部サイトの価格・在庫はスクレイピングで取得しません。v2以降の商品画像は各公式API由来に限り出典付きで表示します。</p>
        <nav className="mt-3 flex flex-wrap gap-3">
          <Link href="/compare" className="hover:text-accent">価格比較</Link>
